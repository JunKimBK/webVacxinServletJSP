...
/**
 * Servlet implementation class ControllerLichSuTiemPhong
 */
...
public class ControllerLichSuTiemPhong extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("khId")!=null){
			id = Integer.parseInt(request.getParameter("khId"));
		}
			request.setAttribute("lichsutiemphong", mlstp.getList(id));
